...
DATA_DIR="astronaut-horse"
STATIC_PROMPT="A high-resolution DSLR image of an astronaut, helmet in hand, rides a white horse"
DYNAMIC_PROMPT="An astronaut, helmet in hand, rides a white horse"
CN_PROMPT="a <token>, helmet in hand, rides a white horse"
