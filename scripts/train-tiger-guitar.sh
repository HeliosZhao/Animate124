...
DATA_DIR="tiger-guitar"
STATIC_PROMPT="a high-resolution DSLR image of a full-bodied tiger standing on its hind legs, confidently playing an acoustic guitar"
DYNAMIC_PROMPT="a full-bodied tiger standing on its hind legs, confidently playing an acoustic guitar"
CN_PROMPT="a <token> standing on its hind legs, confidently playing an acoustic guitar"
